...
import researchstack.wearable.standalone.presentation.main.NoteActivity
import researchstack.wearable.standalone.presentation.main.SettingActivity
import researchstack.wearable.standalone.presentation.main.viewmodel.HomeViewModel
import researchstack.wearable.standalone.presentation.measurement.BiaActivity
import researchstack.wearable.standalone.presentation.measurement.EcgActivity
import researchstack.wearable.standalone.presentation.measurement.PpgActivity
import researchstack.wearable.standalone.presentation.measurement.SpO2Activity
import researchstack.wearable.standalone.presentation.theme.HomeScreenItemBackground
import researchstack.wearable.standalone.presentation.theme.SubTextColor
        ...
        if (BuildConfig.ENABLE_INSTANT_SYNC_BUTTON) {
            ...
            AppButton(HomeScreenItemBackground, stringResource(id = R.string.sync)) {
                WorkManager.getInstance(context).enqueueUniqueWork(
                    "${SyncPrivDataWorker::class.simpleName}-one-time",
