...
import researchstack.wearable.standalone.presentation.measurement.viewmodel.SpO2MeasureViewModel
...
fun MeasureSuccessResult(
    ...
    Column(
        ...
        Row(
            ...
            Image(
                painter = painterResource(id = HomeScreenItem.BLOOD_OXYGEN.getItemIcon()),
