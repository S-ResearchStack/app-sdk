...
private fun TrackerDataType.toGrpcHealthDataType() = when (this) {
    TrackerDataType.LIGHT -> HealthDataType.HEALTH_DATA_TYPE_LIGHT
    TrackerDataType.ACCELEROMETER -> HealthDataType.HEALTH_DATA_TYPE_ACCELEROMETER
    TrackerDataType.SPEED -> TODO()
}
...
fun HealthDataModel.toData(): GrpcHealthData {
    val grpcHealthDataType = when (unifiedDataType) {
        ...
        is TrackerDataType -> (unifiedDataType as TrackerDataType).toGrpcHealthDataType()
